...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-colorizer.lua', 'plenary.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-graphql', 'lspkind-nvim', 'nvim-lspinstall'}, { event = "BufEnter *" }, _G.packer_plugins)]]
