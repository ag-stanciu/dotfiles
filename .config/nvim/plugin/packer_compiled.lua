...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/AutoSave.nvim"
  },
  LuaSnip = {
    config = { "\27LJ\2\n/\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\20plugins.luasnip\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  ["TrueZen.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/TrueZen.nvim"
  },
  ["better-escape.vim"] = {
    config = { "\27LJ\2\n=\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\vescape\19plugins.others\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/better-escape.vim"
  },
  ["dashboard-nvim"] = {
  ...
  ["friendly-snippets"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/friendly-snippets"
  },
  ["galaxyline.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
  ...
  ["indent-blankline.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/indent-blankline.nvim"
  },
  ["lspkind-nvim"] = {
    config = { "\27LJ\2\n>\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\flspkind\19plugins.others\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/lspkind-nvim"
  },
  neoformat = {
    commands = { "Neoformat" },
    loaded = false,
  ...
  ["neoscroll.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/neoscroll.nvim"
  },
  ["nvim-autopairs"] = {
  ...
  ["nvim-base16.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/nvim-base16.lua"
  },
  ["nvim-bufferline.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/nvim-bufferline.lua"
  },
  ["nvim-colorizer.lua"] = {
  ...
  ["nvim-comment"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/nvim-comment"
  },
  ["nvim-compe"] = {
    after = { "nvim-autopairs" },
    after_files = { "/Users/alex/.local/share/nvim/site/pack/packer/opt/nvim-compe/after/plugin/compe.vim" },
    config = { "\27LJ\2\n-\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\18plugins.compe\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/nvim-compe",
    wants = { "LuaSnip" }
  },
  ["nvim-lspconfig"] = {
  ...
  ["nvim-lspinstall"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/nvim-lspinstall"
  },
  ["nvim-tree.lua"] = {
  ...
  ["telescope-fzf-native.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim"
  },
  ["telescope-media-files.nvim"] = {
    commands = { "Telescope" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/telescope-media-files.nvim"
  },
  ["telescope.nvim"] = {
    commands = { "Telescope" },
  ...
  ["vim-graphql"] = {
    loaded = false,
    needs_bufread = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/vim-graphql"
  },
  ["vim-matchup"] = {
    after_files = { "/Users/alex/.local/share/nvim/site/pack/packer/opt/vim-matchup/after/plugin/matchit.vim" },
    loaded = false,
    needs_bufread = true,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/vim-matchup"
  },
  ["vim-startuptime"] = {
    commands = { "StartupTime" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/alex/.local/share/nvim/site/pack/packer/opt/vim-startuptime"
  }
}
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'vim-graphql'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'nvim-lspinstall', 'nvim-treesitter', 'indent-blankline.nvim', 'lspkind-nvim', 'plenary.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
