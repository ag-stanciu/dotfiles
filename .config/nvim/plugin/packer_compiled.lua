...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspkind-nvim', 'nvim-colorizer.lua', 'nvim-lspinstall', 'nvim-treesitter', 'plenary.nvim', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
